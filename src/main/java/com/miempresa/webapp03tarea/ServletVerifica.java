    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (xusu.equals(usuario) && xpas.equals(clave)){
                response.sendRedirect("/WebApp03Tarea/index.html");
            }else{
                   if(!xusu.equals(usuario)){
                       out.println("<p>El usuario no es correcto</p>");
                       out.println("<a href='login.jsp'>Vuelva a logearse</p>");
                   }else{
                       out.println("<p>La clave no es correcta</p>");
                       out.println("<a href='login.jsp'>Vuelva a logearse</p>");
                   }
            }
        } finally { 
